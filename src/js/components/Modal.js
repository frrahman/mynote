...
/**
 * Creates and manages a modal for adding or editing notes. the modal allows users to input a notes title and text,
...
${text}</textarea
  ...
  /**
   *Opens the note modal by appending it to the document body andd setting focus on the title field.
   */
  const open = function () {
  ...
  //Attach click event to closeBtn, when click call the close modal fucntion
 ...
 * @returns {Object} - an object containing function to open the modal , close the modal and handle confirmation.
 */
