 ...
 *
 * @param {string} id - the unique indentifier of the notebook
...
export const NavItem = function (id, name) {
  ...
  /**
   * Handles the click event on the navigation item. updates the note panels title, retrieves the associated notes,
