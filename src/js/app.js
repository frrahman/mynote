...
const showNotebookField = function () {
  ...
  // Active new created notebook and deactive tye last one.
...
/**
 * Renders existing notes in the active notebook. Retrieves note data from the database based on the active notebook's ID abd uses the client to display the notes.
 */
